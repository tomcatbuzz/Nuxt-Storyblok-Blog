...
module.exports = {
  ...
  */
  ...
  generate: {
    routes: function() {
      return axios.get('https://api.storyblok.com/v1/cdn/stories?version=published&token=token=gc4hYmOLpo0KHWuXFr6GVwtt&starts_with=blog&cv=' + Math.floor(Date.now() / 1e3)
      )
      .then(res => {
